...
const LEVELS = [3, 5, 7];
const LOADOUTS: Loadout[] = ['A', 'B', 'C', 'D'];
...
_Auto-generated by \`src/sim/immortalHypothesisSim.test.ts\`. Re-run with \`npm run test:run -- src/sim/immortalHypothesisSim.test.ts\`. Wall clock: ${elapsedSec}s for ${runsPerCell} runs × 3 classes × 3 levels × 4 loadouts = ${runsPerCell * 3 * 3 * 4} delves._
