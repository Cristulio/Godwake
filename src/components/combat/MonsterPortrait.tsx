...
function GoblinSvg({ className }: { className?: string }) {
  return (
    ...
    >
      {/* Skull / cranium */}
      <rect x="5" y="0" width="10" height="2" fill="#4a7022" />
      <rect x="4" y="1" width="12" height="6" fill="#4a7022" />
      {/* Pointy ears */}
      <rect x="2" y="3" width="2" height="3" fill="#4a7022" />
      <rect x="16" y="3" width="2" height="3" fill="#4a7022" />
      <rect x="1" y="4" width="1" height="1" fill="#3a5018" />
      <rect x="18" y="4" width="1" height="1" fill="#3a5018" />
      {/* Red eyes */}
      <rect x="6" y="3" width="2" height="2" fill="#b5302c" />
      <rect x="12" y="3" width="2" height="2" fill="#b5302c" />
      <rect x="6" y="3" width="1" height="1" fill="#ffb347" />
      <rect x="12" y="3" width="1" height="1" fill="#ffb347" />
      {/* Nose */}
      <rect x="9" y="4" width="2" height="2" fill="#3a5018" />
      {/* Snarl + teeth */}
      <rect x="6" y="6" width="8" height="2" fill="#1a1410" />
      <rect x="6" y="6" width="1" height="1" fill="#e8dcc4" />
      <rect x="8" y="6" width="1" height="1" fill="#e8dcc4" />
      <rect x="11" y="6" width="1" height="1" fill="#e8dcc4" />
      <rect x="13" y="7" width="1" height="1" fill="#e8dcc4" />
      {/* Neck */}
      <rect x="8" y="8" width="4" height="1" fill="#4a7022" />
      {/* Torso (small, ragged) */}
      <rect x="6" y="9" width="8" height="6" fill="#5a4030" />
      <rect x="6" y="9" width="8" height="1" fill="#3a2e22" />
      <rect x="8" y="11" width="4" height="3" fill="#3a2e22" />
      {/* Belt */}
      <rect x="6" y="15" width="8" height="1" fill="#1a1410" />
      {/* Loincloth */}
      <rect x="7" y="16" width="6" height="3" fill="#3a2e22" />
      {/* Left arm */}
      <rect x="4" y="9" width="2" height="7" fill="#4a7022" />
      <rect x="3" y="14" width="3" height="2" fill="#4a7022" />
      {/* Right arm holding scimitar */}
      <rect x="14" y="9" width="2" height="7" fill="#4a7022" />
      <rect x="14" y="14" width="3" height="2" fill="#4a7022" />
      {/* Scimitar curve */}
      <rect x="16" y="5" width="1" height="6" fill="#b5a282" />
      <rect x="17" y="11" width="1" height="2" fill="#b5a282" />
      <rect x="18" y="13" width="1" height="2" fill="#b5a282" />
      <rect x="17" y="5" width="1" height="2" fill="#e8dcc4" />
      <rect x="15" y="12" width="2" height="1" fill="#6b4a2e" />
      {/* Legs */}
      <rect x="7" y="19" width="2" height="9" fill="#4a7022" />
      <rect x="11" y="19" width="2" height="9" fill="#4a7022" />
      <rect x="7" y="22" width="1" height="6" fill="#3a5018" />
      <rect x="11" y="22" width="1" height="6" fill="#3a5018" />
      {/* Bare feet */}
      <rect x="5" y="28" width="5" height="3" fill="#4a7022" />
      <rect x="10" y="28" width="5" height="3" fill="#4a7022" />
      <rect x="5" y="30" width="5" height="1" fill="#3a5018" />
      <rect x="10" y="30" width="5" height="1" fill="#3a5018" />
    </svg>
  );
}
