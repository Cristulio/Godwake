...
// ─────────────────────────────────────────────────────────────────────────
// "HD 8-bit" direction. Same grid + crispEdges + viewBox + pose as the
// originals; elevated with: a warm/cool atmospheric backlight for silhouette
// separation, 4-5 step tonal ramps per material (deep-shadow → base → mid →
// light → rim) instead of flat 2-tone, an upper-left amber key light with a
// cool counter-rim, 1px dithering at the big tone boundaries, and specular
// pops on metal / eyes / gems. Late-NES / early-16-bit polish, not a new
// style. Palette stays BG2-mean: amber torch, deep teal shadow, blood, gold.
// ─────────────────────────────────────────────────────────────────────────
...
function DruidSvg({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-label="Druid"
    >
      {/* Atmospheric backlight — warm-green grove haze */}
      <ellipse cx="12" cy="17" rx="13" ry="18" fill="#5a8a3a" opacity="0.07" />
      <ellipse cx="12" cy="14" rx="9" ry="13" fill="#e8a020" opacity="0.05" />
      {/* Ground-contact shadow */}
      <ellipse cx="12" cy="39" rx="9" ry="1.6" fill="#000" opacity="0.42" />

      {/* Antlered crown — wood ramp with a lit edge */}
      <rect x="6" y="1" width="1" height="2" fill="#5a3f24" />
      <rect x="5" y="0" width="1" height="2" fill="#7a5a36" />
      <rect x="5" y="0" width="1" height="1" fill="#a8814a" />
      ...
      <rect x="7" y="4" width="1" height="4" fill="#1a2c12" />
      <rect x="16" y="4" width="1" height="4" fill="#1a2c12" />
      ...
      <rect x="10" y="6" width="1" height="1" fill="#7aa84a" />
      <rect x="14" y="6" width="1" height="1" fill="#7aa84a" />
      {/* Grey-green beard / moss — ramped */}
      <rect x="8" y="9" width="8" height="3" fill="#6b785a" />
      <rect x="9" y="9" width="6" height="1" fill="#909c7a" />
      ...
      <rect x="5" y="12" width="2" height="3" fill="#1a2c12" />
      <rect x="17" y="12" width="2" height="3" fill="#1a2c12" />
      ...
      <rect x="6" y="14" width="1" height="14" fill="#2a2014" />
      <rect x="7" y="14" width="1" height="14" fill="#33271a" />
      <rect x="17" y="14" width="1" height="14" fill="#2a2014" />
      <rect x="11" y="14" width="2" height="14" fill="#5a4630" />
      {/* Robe dither texture */}
      <rect x="9" y="20" width="1" height="1" fill="#5a4630" />
      <rect x="14" y="22" width="1" height="1" fill="#5a4630" />
      <rect x="10" y="24" width="1" height="1" fill="#33271a" />
      ...
      <rect x="17" y="17" width="1" height="6" fill="#5a4630" />
      ...
      {/* Living sprig bound at the staff-head — glowing */}
      <ellipse cx="21" cy="1" rx="4" ry="3" fill="#5a8a3a" opacity="0.18" />
      ...
      <rect x="20" y="0" width="2" height="1" fill="#a8d050" />
      <rect x="20" y="2" width="2" height="1" fill="#7aa84a" />

      {/* Robe lower hem */}
      <rect x="6" y="28" width="12" height="2" fill="#2a2014" />
...
function FighterSvg({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-label="Fighter"
    >
      {/* Atmospheric backlight — warm torch behind the steel */}
      <ellipse cx="12" cy="16" rx="13" ry="18" fill="#e8a020" opacity="0.08" />
      <ellipse cx="12" cy="13" rx="9" ry="12" fill="#ffb040" opacity="0.05" />
      {/* Ground-contact shadow */}
      <ellipse cx="12" cy="39" rx="9" ry="1.6" fill="#000" opacity="0.42" />

      {/* Plume / crest — gold ramp */}
      <rect x="11" y="0" width="2" height="1" fill="#f4d042" />
      <rect x="11" y="0" width="1" height="1" fill="#fff4c0" />
      {/* Helmet crown — brass ramp */}
      ...
      <rect x="14" y="2" width="2" height="5" fill="#6b4a2e" />
      <rect x="7" y="3" width="1" height="5" fill="#4a3216" />
      <rect x="16" y="3" width="1" height="5" fill="#4a3216" />
      {/* Visor slit + amber eye-fire */}
      <rect x="9" y="4" width="6" height="2" fill="#140d08" />
      <rect x="10" y="4" width="1" height="1" fill="#f4a742" />
      <rect x="13" y="4" width="1" height="1" fill="#f4a742" />
      <rect x="10" y="4" width="1" height="1" fill="#ffd070" opacity="0.7" />
      {/* Cheek / jaw plates */}
      <rect x="8" y="7" width="8" height="2" fill="#6b4a2e" />
      <rect x="8" y="7" width="8" height="1" fill="#8c6232" />
      <rect x="9" y="8" width="6" height="1" fill="#5a3f24" />
      {/* Neck */}
      <rect x="10" y="9" width="4" height="1" fill="#2a1d12" />

      {/* Shoulders / pauldrons — ramped with rim */}
      ...
      <rect x="17" y="10" width="2" height="2" fill="#5a3f24" />
      <rect x="7" y="10" width="3" height="1" fill="#d4b062" />
      {/* Chest plate — steel-warm ramp, lit dome */}
      <rect x="7" y="12" width="10" height="9" fill="#3a2e22" />
      <rect x="6" y="12" width="1" height="9" fill="#5a4030" />
      <rect x="17" y="12" width="1" height="9" fill="#2a2018" />
      <rect x="8" y="12" width="3" height="2" fill="#5a4434" />
      <rect x="9" y="12" width="2" height="1" fill="#7a5c44" />
      {/* Chestplate dither down the shaded side */}
      <rect x="15" y="14" width="1" height="1" fill="#2a2018" />
      <rect x="14" y="16" width="1" height="1" fill="#2a2018" />
      <rect x="15" y="18" width="1" height="1" fill="#2a2018" />
      ...
      <rect x="11" y="14" width="1" height="1" fill="#fff4c0" />
      {/* Belt */}
      <rect x="6" y="21" width="12" height="1" fill="#140d08" />
      ...
      {/* Longsword — steel ramp with bright spine + specular */}
      ...
      <rect x="18" y="15" width="4" height="1" fill="#a8814a" opacity="0.5" />
      ...
      {/* Shield — brass ramp, domed boss, gold rivets */}
      ...
      <rect x="1" y="12" width="1" height="2" fill="#c89a5a" />
      <rect x="3" y="13" width="1" height="11" fill="#4a3216" />
      <rect x="1" y="15" width="2" height="2" fill="#d4b062" />
      <rect x="1" y="15" width="1" height="1" fill="#f4d042" />
      <rect x="1" y="20" width="2" height="2" fill="#d4b062" />
      <rect x="1" y="20" width="1" height="1" fill="#f4d042" />

      {/* Hip / skirt */}
      <rect x="7" y="22" width="10" height="3" fill="#3a2e22" />
      <rect x="7" y="22" width="10" height="1" fill="#5a4030" />
      <rect x="11" y="22" width="2" height="3" fill="#5a4434" />
      {/* Right leg — greave ramp */}
      <rect x="8" y="25" width="3" height="9" fill="#3a2e22" />
      <rect x="8" y="25" width="1" height="9" fill="#5a4030" />
      <rect x="10" y="25" width="1" height="9" fill="#2a2018" />
      {/* Left leg */}
      <rect x="13" y="25" width="3" height="9" fill="#3a2e22" />
      <rect x="13" y="25" width="1" height="9" fill="#5a4030" />
      <rect x="15" y="25" width="1" height="9" fill="#2a2018" />
      {/* Boots — sabatons with a steel toe-cap glint */}
      <rect x="7" y="34" width="5" height="4" fill="#140d08" />
      <rect x="7" y="34" width="5" height="1" fill="#3a2e22" />
      <rect x="7" y="38" width="5" height="1" fill="#5a4030" />
      <rect x="7" y="37" width="2" height="1" fill="#6a7080" />
      <rect x="12" y="34" width="5" height="4" fill="#140d08" />
      <rect x="12" y="34" width="5" height="1" fill="#3a2e22" />
      <rect x="12" y="38" width="5" height="1" fill="#5a4030" />
      <rect x="12" y="37" width="2" height="1" fill="#6a7080" />
    </svg>
  );
}
...
function RogueSvg({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-label="Rogue"
    >
      {/* Atmospheric backlight — cold teal, the assassin reads from the dark */}
      <ellipse cx="12" cy="16" rx="12" ry="17" fill="#1c3a3a" opacity="0.16" />
      <ellipse cx="12" cy="13" rx="8" ry="11" fill="#2e5a52" opacity="0.08" />
      {/* Ground-contact shadow */}
      <ellipse cx="12" cy="39" rx="9" ry="1.6" fill="#000" opacity="0.42" />
      ...
      <rect x="7" y="3" width="10" height="2" fill="#1a1614" />
      ...
      <rect x="7" y="5" width="2" height="4" fill="#352e29" />
      {/* Hood rim catch-light — cool teal, upper-left */}
      <rect x="7" y="4" width="4" height="1" fill="#3a564e" />
      <rect x="7" y="5" width="1" height="3" fill="#3a564e" />
      <rect x="7" y="4" width="2" height="1" fill="#4a7268" />
      {/* Hood front fold */}
      <rect x="6" y="10" width="12" height="1" fill="#0e0b09" />
      {/* Face shadow inside hood */}
      <rect x="8" y="6" width="8" height="4" fill="#0a0806" />
      {/* Eye glints — yellow with red core */}
      ...
      {/* Cape spilling over shoulders */}
      <rect x="4" y="11" width="16" height="2" fill="#2a2420" />
      <rect x="4" y="11" width="16" height="1" fill="#352e29" />
      ...
      <rect x="17" y="13" width="1" height="6" fill="#14110f" />
      <rect x="8" y="13" width="2" height="5" fill="#4a3a2c" />
      {/* Leather chest straps + buckle gleam */}
      <rect x="8" y="14" width="8" height="1" fill="#5a4030" />
      <rect x="8" y="17" width="8" height="1" fill="#5a4030" />
      <rect x="11" y="14" width="1" height="1" fill="#8a6a48" />
      {/* Belt with pouches */}
      ...
      <rect x="9" y="20" width="2" height="1" fill="#6b4a36" />
      ...
      <rect x="19" y="18" width="2" height="1" fill="#d8bd92" />
      {/* Right-hand dagger (down) — steel ramp + specular */}
      ...
      {/* Left-hand dagger (up — reverse grip) */}
      ...
      {/* Lower legs */}
      <rect x="8" y="30" width="3" height="4" fill="#3a2e22" />
      <rect x="8" y="30" width="1" height="4" fill="#1f1a18" />
      <rect x="13" y="30" width="3" height="4" fill="#3a2e22" />
      <rect x="13" y="30" width="1" height="4" fill="#1f1a18" />
      {/* Boots */}
...
function WizardSvg({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-label="Wizard"
    >
      {/* Atmospheric backlight — arcane violet bloom */}
      <ellipse cx="12" cy="18" rx="13" ry="19" fill="#7a5db8" opacity="0.10" />
      <ellipse cx="12" cy="15" rx="9" ry="13" fill="#a48ee0" opacity="0.06" />
      {/* Ground-contact shadow */}
      <ellipse cx="12" cy="39" rx="9" ry="1.6" fill="#000" opacity="0.42" />
      ...
      <rect x="7" y="6" width="1" height="1" fill="#6a52a0" />
      ...
      <rect x="9" y="10" width="1" height="1" fill="#7a8ad0" />
      <rect x="13" y="10" width="1" height="1" fill="#7a8ad0" />
      {/* White beard — ramped */}
      <rect x="8" y="13" width="8" height="3" fill="#cfc4ac" />
      <rect x="8" y="13" width="8" height="1" fill="#e8dcc4" />
      ...
      <rect x="11" y="18" width="2" height="14" fill="#473570" />
      {/* Robe dither */}
      ...
      <rect x="11" y="24" width="2" height="1" fill="#c4b0f0" />
      ...
      <rect x="4" y="22" width="1" height="1" fill="#f4d042" />
      ...
      <rect x="17" y="21" width="1" height="6" fill="#473570" />
      ...
      {/* Staff crystal orb — glowing, layered bloom */}
      <ellipse cx="21" cy="2" rx="5" ry="5" fill="#a48ee0" opacity="0.22" />
      ...
      <polygon points="9,34 11,32 11,34" fill="#473570" />
      {/* Boots */}
...
function BarbarianSvg({ className }: { className?: string }) {
  return (
    ...
    >
      {/* Atmospheric backlight — blood-warm rage haze */}
      <ellipse cx="12" cy="17" rx="13" ry="18" fill="#b5302c" opacity="0.08" />
      <ellipse cx="12" cy="14" rx="9" ry="12" fill="#e8a020" opacity="0.05" />
      {/* Ground-contact shadow */}
      <ellipse cx="12" cy="39" rx="9" ry="1.6" fill="#000" opacity="0.42" />
      ...
      <rect x="9" y="4" width="6" height="1" fill="#dcc098" />
      <rect x="15" y="4" width="1" height="5" fill="#9c7448" />
      ...
      <rect x="10" y="6" width="1" height="1" fill="#e8a020" />
      <rect x="14" y="6" width="1" height="1" fill="#e8a020" />
      ...
      <rect x="4" y="11" width="16" height="1" fill="#dcc098" />
      <rect x="4" y="11" width="2" height="2" fill="#9c7448" />
      <rect x="18" y="11" width="2" height="2" fill="#8c6840" />
      <rect x="6" y="11" width="4" height="1" fill="#ecd4a8" />
      {/* Bare chest with war paint; skin ramp */}
      <rect x="6" y="13" width="12" height="7" fill="#c8a878" />
      <rect x="6" y="13" width="1" height="7" fill="#9c7448" />
      <rect x="17" y="13" width="1" height="7" fill="#8c6840" />
      <rect x="7" y="13" width="3" height="2" fill="#dcc098" />
      {/* Pectoral / ab shading */}
      ...
      <rect x="14" y="18" width="1" height="1" fill="#a88858" />
      {/* Red war-paint chevrons */}
      <rect x="9" y="14" width="2" height="1" fill="#b5302c" />
      <rect x="13" y="14" width="2" height="1" fill="#b5302c" />
      <rect x="9" y="14" width="1" height="1" fill="#e23030" />
      <rect x="13" y="14" width="1" height="1" fill="#e23030" />
      {/* Fur / hide belt */}
      ...
      <rect x="10" y="25" width="1" height="9" fill="#a88858" />
      {/* Left leg */}
      <rect x="13" y="25" width="3" height="9" fill="#c8a878" />
      <rect x="13" y="25" width="1" height="9" fill="#9c7448" />
      <rect x="15" y="25" width="1" height="9" fill="#a88858" />
      {/* Fur leg-wraps */}
...
function RangerSvg({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-label="Ranger"
    >
      {/* Atmospheric backlight — cool forest dusk */}
      <ellipse cx="12" cy="17" rx="12" ry="18" fill="#2e4a22" opacity="0.10" />
      <ellipse cx="12" cy="14" rx="8" ry="12" fill="#4a8278" opacity="0.06" />
      {/* Ground-contact shadow */}
      <ellipse cx="12" cy="39" rx="9" ry="1.6" fill="#000" opacity="0.42" />
      ...
      <rect x="7" y="3" width="1" height="5" fill="#1a2c12" />
      <rect x="15" y="3" width="1" height="5" fill="#1a2c12" />
      <rect x="8" y="3" width="2" height="4" fill="#3f5e30" />
      {/* Hood rim catch-light */}
      <rect x="8" y="3" width="3" height="1" fill="#4a6b3a" />
      <rect x="8" y="4" width="1" height="2" fill="#5a8a3a" />
      {/* Face in the hood shadow — skin ramp */}
      <rect x="9" y="5" width="6" height="4" fill="#c8a878" />
      <rect x="9" y="5" width="1" height="4" fill="#9c7448" />
      <rect x="10" y="5" width="5" height="1" fill="#dcc098" />
      {/* Sharp eyes */}
      <rect x="10" y="6" width="1" height="1" fill="#1a1410" />
      <rect x="13" y="6" width="1" height="1" fill="#3a6a2e" />
      <rect x="13" y="6" width="1" height="1" fill="#5a8a3a" opacity="0.8" />
      {/* Jaw */}
      ...
      <rect x="5" y="10" width="2" height="3" fill="#1a2c12" />
      <rect x="17" y="10" width="2" height="3" fill="#16240e" />
      ...
      <rect x="4" y="7" width="1" height="3" fill="#e8e8d4" />
      ...
      <rect x="4" y="14" width="1" height="4" fill="#1a2c12" />
      <rect x="3" y="17" width="2" height="2" fill="#c8a878" />
      {/* Longbow — tall vertical stave, wood ramp */}
      ...
      {/* Nocked arrow drawn back */}
      <rect x="3" y="16" width="9" height="1" fill="#d8d8c0" />
      <rect x="2" y="16" width="1" height="1" fill="#b4bcce" />
      ...
      <rect x="17" y="14" width="1" height="3" fill="#1a2c12" />
      <rect x="11" y="16" width="2" height="2" fill="#c8a878" />
      {/* Cloak falling down the sides */}
      <rect x="5" y="12" width="1" height="12" fill="#1a2c12" />
      <rect x="18" y="12" width="1" height="8" fill="#16240e" />
