 ...
 * the rival Bhaalspawn whose deaths feed the survivor. The road runs through two
 * canonical strongholds at once: Sendai's Enclave, the drow city carved in rock
 * and riddled with her petrified kin posed mid-ambush, and the storm-charged deep
 * caverns of Abazigal's Lair, filled end to end with the half-blue-dragon's brood.
 *
 * Theme: the held ambush and the breeding storm. Sendai keeps her halls by
 * patience — statuary that wakes, faithful that mend, a matron certain the rock
 * will take you before you reach her seat. Abazigal keeps his by force — wyrmlings
 ...
 * CR 11, early-mid CR 12, mid CR 13, elite CR 15 (Sendai), boss (Abazigal) CR 16.
 */
...
export const WARMUP_POOL: EncounterEntry[] = [
  ...
  },
  {
    ...
    flavorText:
      'Two of the grey figures crack at once, a pace apart, the stone falling off them in the same breath — Sendai sets her ambushers in pairs where the gallery narrows, so that the one you turn from sets its hands on you for the one you turn toward. Neither hurries. Neither has to.',
...
export const EARLY_MID_POOL: EncounterEntry[] = [
  {
    ...
    flavorText:
      'The dark up ahead is crackling faintly, and the crackle has teeth. A blue wyrmling uncoils off a warm ledge, Abazigal\'s own young, the static already arcing blue along its jaws before it strikes — small enough to call young, and lightning enough that the smallness does not help you.',
  ...
  },
  {
    ...
    flavorText:
      'A drow voice speaks one word ahead of you and the gallery drops into a darkness no torch will answer. Out of it comes Sendai\'s handmaiden, war-priestess of the Spider Queen, the venom-scourge wet and writhing in a hand you cannot see — dousing the light so the next lash arrives out of nothing.',
  ...
  },
  {
    ...
    flavorText:
      'Two of Abazigal\'s young come down the warm dark together, jaws crackling, too quick and too eager to bother with cunning. They do not coordinate. They do not need to. They are lightning with teeth, twice over, and they have been hungry in the dark a long time.',
...
export const MID_POOL: EncounterEntry[] = [
  ...
  },
  {
    ...
    flavorText:
      'A half-dragon reaver stands the heart-gallery like a household guard, broad and blue-scaled, a greataxe edged in cobalt scale-metal already swinging in a measured two-stroke. It carries its father\'s storm in its veins and a drilled soldier\'s discipline in its hands, and it means to be at Abazigal\'s side when he becomes a god.',
  ...
  },
  {
    title: 'Two Reavers',
    flavorText:
      'Two half-dragon reavers take the heart-gallery together, greataxes coming in the same disciplined cadence from two sides, the storm in their veins riding down both edges. They are Abazigal\'s sons and they fight like it — no wasted motion, no fear, and no intention of letting you reach their father.',
...
export const ELITE_POOL: EncounterEntry[] = [
  ...
  {
    title: 'Sendai and Her Handmaiden',
    flavorText:
      'Sendai keeps her throne while a handmaiden works the dark around it, dousing the light so the matron\'s mace falls out of a blackness you cannot read, and calling the Spider Queen\'s favour down on the matron each time you draw blood. Fell the priestess and fight Sendai in the light, or fight them both in the dark and lose her in it.',
    monsters: [
      { defId: 'sendai', count: 1 },
      { defId: 'sendai-handmaiden', count: 1 },
    ],
  ...
  {
    title: 'Sendai and the Reaver',
    flavorText:
      'The seam between the two strongholds runs right up to the throne: a half-dragon reaver out of Abazigal\'s brood stands the floor for Sendai, greataxe in its disciplined cadence, while the matron holds you with a word and wakes the stone behind you. The enclave\'s patience and the lair\'s storm, refilling the room faster than you can empty it.',
    monsters: [
      { defId: 'sendai', count: 1 },
      { defId: 'half-dragon-reaver', count: 1 },
    ],
  ...
  },
  {
    ...
    flavorText:
      'A handmaiden floods the throne-hall with conjured darkness while a stormscale drake lashes blind through it and Sendai works the centre, untroubled, fighting in a blackness her kind were born to see through. You cannot find the matron, you cannot answer the drake, and the priestess mends them both from somewhere in the dark.',
    monsters: [
      { defId: 'sendai-handmaiden', count: 1 },
      { defId: 'stormscale-drake', count: 1 },
    ],
  ...
  {
    title: 'Sendai and the Deep-Faithful',
    flavorText:
      'Two kuo-toa deepguards have dragged themselves up from the flooded roads to keep the matron\'s floor, croaking their god-name even here, while Sendai holds her throne and wakes the gallery. The nets foul you, the stone closes, and the matron takes her time, certain the rock will have you long before her own hand needs to.',
    monsters: [
      { defId: 'sendai', count: 1 },
 ...
 * Bhaalspawn pools thick enough to touch: a seam where Sendai's frozen kin lie
 * thickest, and a scorched hollow where Abazigal's storm has burned the rock to
 * glass.
 */
  ...
  rests: [
    {
      ...
      flavorText:
        "A carved recess off the gallery where Sendai's living sentries once kept watch on the road in — a stone bench, a slit to the dark, a cold-lamp long burned out. The matron pulled her breathing guards back toward the throne an age ago and trusted the statues to the rest, so no one watches this niche now but the dead, and the dead do not report. Sit out of the gallery's line a while. The held ambush cannot spring on what it cannot see.",
    },
    {
      title: 'The Lair\'s Warm Lee',
      flavorText:
        "A pocket of the deep caverns the brood does not bother — too small for a drake to turn in, too far from the warm nests for a wyrmling to wander, the rock holding a low steady heat off Abazigal's own body somewhere below. The storm-charge that hums everywhere else in the lair goes quiet here, and the only sound is the great slow breathing of the thing you have come to kill, far down and not yet awake to you. Rest in the warm dark. It will not last.",
    },
  ] as ChapterRoomFlavor[],
  shop: {
    title: 'A Hoarder Among the Brood',
    flavorText:
      "Not every thing in Abazigal's lair worships him. In a side-cavern hung with stolen lamplight something keeps a hoard the way dragons are said to — a hunched, scaled, half-bred thing, too small to be a reaver and too clever to be a drake, that has spent the long years of the breeding pulling the good steel and the forgotten charms off everything the brood killed and never claimed. It does not love its sire. It loves the count of its pile, and it will trade from it for coin, because coin is one more kind of shining thing to keep.",
  } as ChapterRoomFlavor,
  bossDefId: 'abazigal',
  boss: {
    title: 'The Wyrm at the Bottom of the Dark',
    flavorText:
      "The caverns end in a vault that breathes. Coiled across the whole floor of it, scaled cobalt and crackling, is the last and the strongest of the Five — Abazigal, who claimed dragon blood and proved it by taking the half-dragon form and never once setting it down, until the man was gone and only the great storm-blooded wyrm remained. He is immune to the lightning that is the whole of his blood, and he means to be immune to death the same way: he knows, as you do, that the essence of the slain Five flows to the survivor, and he intends to be the one left standing. \"So,\" he says, and the word is thunder in the close rock, \"the runt of Bhaal's litter comes down to be a stepping-stone. Come closer, little kin. I have room in me for one more god.\"",
    xpReward: 5400,
    goldReward: 720,
  },
} as const;
...
/**
 * Pre-boss intel card for Abazigal, shaped to {@link BossIntelCard}. Chapter 13
