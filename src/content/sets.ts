...
export const SETS: LegendarySet[] = [
  {
    ...
    bonuses: [
      ...
      {
        piecesRequired: 3,
        label: '3-piece: heal 5% of the damage you deal',
        bonuses: { lifestealPct: 5 },
      },
    ],
  },
  {
  ...
  },
  {
    ...
    bonuses: [
      ...
      {
        piecesRequired: 3,
        label: '3-piece: heal 6% of the damage you deal',
        bonuses: { lifestealPct: 6 },
      },
    ],
  },
  {
  ...
  },
  {
    ...
    bonuses: [
      ...
      {
        piecesRequired: 3,
        label: '3-piece: +4 spell damage and heal 5% of the damage you deal',
        bonuses: { spellDamageBonus: 4, lifestealPct: 5 },
      },
    ],
  },
  {
    ...
    bonuses: [
      ...
      {
        piecesRequired: 3,
        label: '3-piece: crits land on 19–20, and heal 5% of the damage you deal',
        bonuses: { critRangeBonus: 1, lifestealPct: 5 },
      },
    ],
  },
  ...
  // --- Global ascension-exclusive sets (class-agnostic) --------------------
  {
    ...
    bonuses: [
      ...
      {
        piecesRequired: 3,
        label: '3-piece: regenerate 3 HP each turn, and heal 5% of the damage you deal',
        bonuses: { regenPerTurn: 3, lifestealPct: 5 },
      },
    ],
  },
  {
    ...
    bonuses: [
      ...
      {
        piecesRequired: 3,
        label: '3-piece: crits land on 19–20, and heal 6% of the damage you deal',
        bonuses: { critRangeBonus: 1, lifestealPct: 6 },
      },
    ],
  },
];
