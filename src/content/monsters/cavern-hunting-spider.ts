...
export const CAVERN_HUNTING_SPIDER: Monster = MonsterSchema.parse({
  ...
  flavorText:
    'Big as a war-hound and twice as patient, it hunts the faerzress-lit galleries below Ust Natha. The drow do not keep it; they simply walk a different corridor. It has learned that the things which come from the surface do not know which corridor to avoid.',
});
