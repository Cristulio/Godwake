...
/**
 * Drow Matron Mother — Zhal Vasha's boss. A spider-priestess of Arachne at the
 * head of one of Zhal Vasha's eight Houses.
 *
 ...
 *   - Then a `summon` — Arachne lends her a spider-child handmaiden (reuses the
 ...
 *     down. The first foreshadowing of Szendra's statue-gate, three chapters on.
 *   - A `debuff` — her cured venom hangs on the air as a web of poison (player
 *     attacks at disadvantage, CON DC 14).
 *   - At half HP a `phase`: Arachne turns Her regard on the duel and the Matron's
...
export const DROW_MATRON_MOTHER: Monster = MonsterSchema.parse({
  ...
  actions: [
    ...
    },
    {
      ...
      once: true,
      description:
        "She sets two fingers to the obsidian sigil and speaks a name in the old tongue, and the floor's own shadow gathers itself up on too many legs. Arachne does not love Her priestesses. But She lends them Her children when a surface-thing has climbed too far — a handmaiden to stand between the Matron and the blade, so that the blade never reaches the Matron at all.",
    },
    {
      kind: 'debuff',
    ...
    },
    {
      ...
      reach: 5,
      description:
        "The dagger is cold mithral with the Arachne-glyph chased into the flat, the edge wet with a priestess-cured drow venom. She does not draw it back between strokes — she opens you and turns the wrist on the same motion.",
    },
    {
      kind: 'attack',
      name: "Spider's Curse",
      ...
      range: [60, 120],
      description:
        "The Matron Mother lifts her free hand and traces a spider-glyph in the air. The web ignites between her fingers and falls on you in burning strands — Arachne's punishment for surface-fire stolen by a surface-thing.",
    },
  ],
  ...
  flavorText:
    "Tall, slender, robed in spider-silk dyed the same arterial red as the temple banners behind her. The obsidian holy-symbol of Arachne sits at her throat on a chain of finger-bones — surface-elven, by the proportions. Zhal Vasha's eight Matron Mothers rule by murder and by leaving the murders un-witnessed. This one has been Matron for sixty years. She has not been challenged twice by the same House.",
});
