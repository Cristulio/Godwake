...
/**
 * Velnaris — Chapter 11 boss, the captor, the climax of the whole soul-theft
  ...
  phases: [
    {
      ...
      acDelta: -2,
      enterText:
        "The white light under his skin tears. For one moment the scholar's face is honestly afraid — of you, of the thing rising out of the wound — and then god-taint he carved out of you decides it would rather wear him, and Velnaris comes apart into the shape your father left in the blood. The Slayer stands where the captor stood: no more procedure, no more fond patience, only the appetite he stole from you given hands. It forgets to guard. It does not forget to feed.",
      addActions: [
        {
          kind: 'debuff',
