...
/**
 * Saradush Marauder — Chapter 12 fodder. The human rabble of Yaga-Shura's
 * siege: sellswords and brigands who took the giant's coin to ring a city of
 * refugee Bhaalspawn and starve it into the fire. A plain `attack` brute with a
  ...
  actions: [
    {
      ...
      reach: 5,
      description:
        'A heavy axe taken off a Saradush guardsman who no longer needs it, the haft re-wrapped in stolen finery. He swings it the way a man swings at a door he means to be through, not at a thing that might swing back.',
    },
  ],
  flavorText:
    "Yaga-Shura did not march only fire giants to Saradush. The bulk of the ring is this: mercenaries and marauders out of every hard country, paid in the promise of a sacked city and given the one task of seeing that nothing inside the walls gets out alive. They have not had to fight for weeks — only to wait, and burn what tries to flee, and grow fat on the plunder of the camps. The waiting has made them slow. It has not made them merciful.",
});
