...
/**
 * Drow Warrior — Zhal Vasha house-guard, lethal first strike. The high DEX
  ...
  actions: [
    {
      ...
      reach: 5,
      description:
        "The warrior steps in once and the scimitar is already past your guard — Zhal Vasha's house-guards drill the opening cut for ten years before they wear the cloak. The blade tastes you and is gone again.",
    },
  ],
  resistances: ['poison'],
  flavorText:
