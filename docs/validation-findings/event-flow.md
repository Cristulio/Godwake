...
- **Fallback wording** (Part 1): CONFIRMED — each of the 5 `grant_quirk_reroll` events surfaces its own god-appropriate fallback. No Waukeen leak in non-Waukeen contexts.
- **L1 smart-grant** (Part 2): CONFIRMED — when fired against a quirk-less character, gold delta is exactly +5 every trial across 200 × 5 events = 1000 trials.
...
|---|---:|---:|---:|---:|---:|---:|---:|
| Fighter (human) L1 | 50 | 550 | 93 | 74 | 74 | 74 | 0 |
| Fighter (human) L3 | 50 | 550 | 93 | 78 | 78 | 78 | 0 |
| Rogue (wood-elf) L1 | 50 | 550 | 93 | 76 | 76 | 76 | 0 |
| Rogue (wood-elf) L3 | 50 | 550 | 93 | 79 | 79 | 79 | 0 |
| Wizard (tiefling, default) L1 | 50 | 550 | 93 | 76 | 76 | 76 | 0 |
| Wizard (tiefling, default) L3 | 50 | 550 | 93 | 79 | 79 | 79 | 0 |
